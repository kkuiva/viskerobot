...
public:
  ...
  : Node("xarm_api_demo")
  {
    ...
    //roboti asendid (rad): koduasend, asend kuubiku kohal enne haaramist, viskamise lõppasend
    ...
    joint_pos_3_ = { 0.0, 0.0, 0.0, PI/2, 0.0, 0.0, 0.0 };
  ...
  bool run_demo()
  {
    ...
    //viske lõppasend
    if (!move_joint(joint_pos_3_, 6, 100.0, false)) {
      return false;
    }
